...
WARNING: The Hadoop and Spark modules are not included in the 4.0.0-beta.2 distribution. The examples in
this section are presented as static code and will be restored in a future release.
