...
** Execute with the `-DincludeNeo4j` option to include neo4j-gremlin tests. Transactional tests on Gremlin Server,
Gremlin Driver, and GLVs will run automatically with integration tests against the `TinkerTransactionGraph`.
