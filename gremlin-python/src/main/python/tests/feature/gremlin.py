...
world.gremlins = {
    ...
    'g_V_valuesXdatetimeX_isXtypeOfXGType_DATETIMEXX_whereXisXgtXdatetimeX2020_01_01XXXX': [(lambda g:g.add_v('event').property('datetime', datetime.datetime.fromisoformat('2023-08-08T12:34:56+00:00'))), (lambda g:g.V().values('datetime').is_(P.type_of(GType.DATETIME)).where(__.is_(P.gt(datetime.datetime.fromisoformat('2020-01-01T00:00+00:00')))))], 
    ...
    'g_injectXdatetimeX_isXtypeOfXGType_DATETIMEXX_groupCount': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-08T12:34:56+00:00')).is_(P.type_of(GType.DATETIME)).group_count())], 
    ...
    'g_mergeEXlabel_knows_out_vadasX_optionXonCreate_created_YX_optionXonMatch_created_NX_exists_updated_override_prohibited': [(lambda g, xx1=None,xx3=None,xx2=None:g.add_v('person').property('name', 'marko').as_('a').add_v('person').property('name', 'vadas').as_('b').add_e('knows').from_('a').to('b').property('created', 'Y').add_e('knows').from_('b').to('a').property('created', 'Y')), (lambda g, xx1=None,xx3=None,xx2=None:g.merge_e(xx1).option(Merge.on_create, xx2).option(Merge.on_match, xx3))], 
    'g_mergeEXout_vadasX_optionXonCreate_created_YX_optionXonMatch_created_NX_exists_updated_error': [(lambda g, xx1=None,xx3=None,xx2=None:g.add_v('person').property('name', 'marko').as_('a').add_v('person').property('name', 'vadas').as_('b').add_e('knows').from_('a').to('b').property('created', 'Y').add_e('knows').from_('b').to('a').property('created', 'Y')), (lambda g, xx1=None,xx3=None,xx2=None:g.merge_e(xx1).option(Merge.on_create, xx2).option(Merge.on_match, xx3)), (lambda g, xx1=None,xx3=None,xx2=None:g.V()), (lambda g, xx1=None,xx3=None,xx2=None:g.E()), (lambda g, xx1=None,xx3=None,xx2=None:g.E().has_label('knows').has('created', 'Y')), (lambda g, xx1=None,xx3=None,xx2=None:g.E().has_label('knows').has('created', 'N').out_v().has('name', 'vadas'))], 
    'g_mergeEXout_vadasX_optionXonCreate_created_YX_optionXonMatch_created_NX_exists_updated_override_prohibited': [(lambda g, xx1=None,xx3=None,xx2=None:g.add_v('person').property('name', 'marko').as_('a').add_v('person').property('name', 'vadas').as_('b').add_e('knows').from_('a').to('b').property('created', 'Y').add_e('knows').from_('b').to('a').property('created', 'Y')), (lambda g, xx1=None,xx3=None,xx2=None:g.merge_e(xx1).option(Merge.on_create, xx2).option(Merge.on_match, xx3))], 
    'g_withSideEffect_mergeEXout_vadasX_optionXonCreate_created_YX_optionXonMatch_created_NX_exists_updated_dynamic_override_sketchily_allowed': [(lambda g, xx1=None,xx3=None:g.add_v('person').property('name', 'marko').as_('a').add_v('person').property('name', 'vadas').as_('b').add_e('knows').from_('a').to('b').property('created', 'Y').add_e('knows').from_('b').to('a').property('created', 'Y')), (lambda g, xx1=None,xx3=None:g.merge_e(xx1).option(Merge.on_create, __.select('sideEffect1')).option(Merge.on_match, xx3)), (lambda g, xx1=None,xx3=None:g.V()), (lambda g, xx1=None,xx3=None:g.E()), (lambda g, xx1=None,xx3=None:g.E().has_label('knows').has('created', 'Y')), (lambda g, xx1=None,xx3=None:g.E().has_label('knows').has('created', 'N').out_v().has('name', 'vadas'))], 
    ...
    'g_withSideEffect_withSideEffect_mergeE_outV_dynamic_override_prohibited': [(lambda g, xx1=None:g.add_v('person').property('name', 'marko').add_v('person').property('name', 'vadas')), (lambda g, xx1=None:g.merge_e(xx1).option(Merge.on_create, __.select('sideEffect1')))], 
    ...
    'g_withSideEffect_mergeE_inV_dynamic_override_prohibited': [(lambda g, xx1=None:g.add_v('person').property('name', 'marko').add_v('person').property('name', 'vadas')), (lambda g, xx1=None:g.merge_e(xx1).option(Merge.on_create, __.select('sideEffect1')))], 
    ...
    'g_mergeE_label_dynamic_override_prohibited': [(lambda g, xx1=None:g.add_v('person').property('name', 'marko').add_v('person').property('name', 'vadas')), (lambda g, xx1=None:g.merge_e(xx1).option(Merge.on_create, __.select('sideEffect1')))], 
    ...
    'g_withSideEffect_mergeE_id_dynamic_override_prohibited': [(lambda g, xx1=None:g.add_v('person').property('name', 'marko').add_v('person').property('name', 'vadas')), (lambda g, xx1=None:g.merge_e(xx1).option(Merge.on_create, __.select('sideEffect1')))], 
    ...
    'g_withSideEffect_mergeV_label_dynamic_override_prohibited': [(lambda g, xx1=None:g.merge_v(xx1).option(Merge.on_create, __.select('sideEffect1')))], 
    ...
    'g_E_properties': [(lambda g:g.add_v('person').property('name', 'alice').as_('a').add_v('person').property('name', 'bob').as_('b').add_e('knows').from_('a').to('b').property('weight', 0.5).property('since', 2020)), (lambda g:g.E().properties())], 
    'g_E_propertiesXsinceX': [(lambda g:g.add_v('person').property('name', 'alice').as_('a').add_v('person').property('name', 'bob').as_('b').add_e('knows').from_('a').to('b').property('weight', 0.5).property('since', 2020)), (lambda g:g.E().properties('since'))], 
    'g_E_properties_multi_edges': [(lambda g:g.add_v('person').property('name', 'alice').as_('a').add_v('person').property('name', 'bob').as_('b').add_e('knows').from_('a').to('b').property('weight', 0.5).property('since', 2020).add_e('likes').from_('a').to('b').property('weight', 1.0).property('tag', 'friend')), (lambda g:g.E().properties())], 
    ...
    'g_E_properties_order': [(lambda g:g.add_v('person').property('name', 'alice').as_('a').add_e('self').from_('a').to('a').property('weight', 0.5).property('a', 10).add_e('self').from_('a').to('a').property('weight', 1.0).property('a', 11).add_e('self').from_('a').to('a').property('weight', 0.4).property('a', 12).add_e('self').from_('a').to('a').property('weight', 1.0).property('a', 13).add_e('self').from_('a').to('a').property('weight', 0.4).property('a', 14).add_e('self').from_('a').to('a').property('weight', 0.2).property('a', 15)), (lambda g:g.E().properties().order())], 
    'g_E_properties_order_byXdescX': [(lambda g:g.add_v('person').property('name', 'alice').as_('a').add_e('self').from_('a').to('a').property('weight', 0.5).property('a', 10).add_e('self').from_('a').to('a').property('weight', 1.0).property('a', 11).add_e('self').from_('a').to('a').property('weight', 0.4).property('a', 12).add_e('self').from_('a').to('a').property('weight', 1.0).property('a', 13).add_e('self').from_('a').to('a').property('weight', 0.4).property('a', 14).add_e('self').from_('a').to('a').property('weight', 0.2).property('a', 15)), (lambda g:g.E().properties().order().by(Order.desc))], 
